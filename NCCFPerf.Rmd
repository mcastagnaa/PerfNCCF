...
* make sure that the adequate level of governance (beyond the one required by the regulator) is properly addressed in all the relevant aspects. That is: make sure that a clear definition of each product is available by maintaining a structure that enable the unequivocal listing of: 
...
* explore new channels to convey that information (and, possibly, have some information back)
